...
ggplot2::ggsave(filename = "../figs/species_abundance_ggplot.png", 
                ...
                height = 3.5)
```
# the things inside the {} at the beginning of this last section is a detailed description of the image, which is 'alternative text' for screen readers used as visual aids
