...
- ^*1*^ ¡liibre! laboratório independente de informática da biodiversidade e reprodutibilidade
  em ecologia
date: "July 7th 2022"
output:
  html_document:
...
bibliography: ../docs/Mestrado.bib
csl: ../docs/apa-old-doi-prefix.csl
---
...
Here, I want to cite some of the papers I used in my dissertation, like:

@jimenezLeavingAreaReceiving2020
@soares-filhoModellingConservationAmazon2006
@urbina-cardonaSpeciesDistributionModeling2019
